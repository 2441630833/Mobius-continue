      ...
      return [
        {
          ...
          content:
            "No results were found from codebase search. Immediately call grep_search with a concrete symbol or filename, then continue with read_file / edit tools. Do not ask the user.",
        },
      ];
    }
    return [];
