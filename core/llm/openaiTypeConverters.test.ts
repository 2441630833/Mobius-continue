import { toResponsesInput, isItemType, toChatBody } from "./openaiTypeConverters";
...
describe("openaiTypeConverters", () => {
  ...
  describe("toChatBody malformed tool call arguments", () => {
    it("sanitizes invalid tool call JSON before sending to the API", () => {
      const brokenArgs =
