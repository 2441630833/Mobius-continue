...
export function StepContainerPreToolbar({
  ...
  return (
    <div className="outline-command-border -outline-offset-0.5 rounded-default bg-editor !my-2 flex min-w-0 w-full max-w-full flex-col outline outline-1">
      <div
        className={`find-widget-skip bg-editor sticky -top-2 z-10 m-0 flex min-w-0 w-full flex-wrap items-center justify-between gap-x-2 gap-y-1 px-1.5 py-1 ${isExpanded ? "rounded-t-default border-command-border border-b" : "rounded-default"}`}
