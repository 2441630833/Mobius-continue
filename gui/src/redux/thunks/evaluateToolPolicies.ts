...
import { MessageModes, Tool, ToolCallState } from "core";
import { IIdeMessenger } from "../../context/IdeMessenger";
import { shouldAutoApproveDuringAgentTask } from "../../util/agentAutoApprove";
...
async function evaluateToolPolicy(
  ...
  const resolvedPolicy = dynamicPolicy;
  if (shouldAutoApproveDuringAgentTask(mode, resolvedPolicy)) {
    return {
