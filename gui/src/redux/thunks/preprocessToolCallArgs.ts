            ...
            contextItems: [
              {
                ...
                description: "",
                content: (errorMessage ?? "").includes("not found")
                  ? `${tcState.toolCall.function.name || "(unnamed tool)"} failed: ${errorMessage}\n\nPlease try something else or request further instructions.`
                  : `${tcState.toolCall.function.name || "(unnamed tool)"} failed because the arguments were invalid, with the following message: ${errorMessage}\n\nPlease try something else or request further instructions.`,
                hidden: false,
              },
            ],
          }),
