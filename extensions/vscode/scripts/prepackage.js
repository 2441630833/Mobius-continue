...
void (async () => {
  ...
  const intellijWebviewExists = fs.existsSync(indexHtmlPath);

  if (intellijWebviewExists) {
    ...
    console.log(
      "[info] Skipping JetBrains webview copy (intellij webview/index.html not found)",
    );
  }
